...
public class Enemy6 : Enemy
{
    ...
    [SerializeField] private Animator enemy6Animator;
    ...
    public override void MoveEnemy()
    {
        ...
        int i = EnemyPos.x - 1;
        int j = EnemyPos.y - 1;
        for (; i <= EnemyPos.x + 1 && j <= EnemyPos.y + 1; i++, j++)
        {
    ...
    public override void AttackPlayer()
    {
        ...
        enemy6Animator.SetTrigger("Attack");
    }
    ...
    public override void TakeDamage(int damage)
    {
        ...
        if (health <= 0)
        {
            ...
            EnemyInfo.Instance.hideInfoTiles();
            StartCoroutine(DeathAnimation(rend, deadParticleEffect, enemy6Animator, enemyCountDown));
            Grid.Instance.enemyLocations.Remove(EnemyPos);
